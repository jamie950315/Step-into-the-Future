...
void loop()
{
    ...
    if (Serial.available())
    {
        ...
        if (val == 'l')
        {
            //if receive l, turn on the two motors for 3 seconds, then turn off for 1 second, then turn on for 4 seconds, then turn off
        ...
        {
            //if receive L, turn on the two motors for 7 seconds, then turn off
            digitalWrite(motor1pos, HIGH);
            digitalWrite(motor1neg, LOW);
            digitalWrite(motor2pos, HIGH);
            digitalWrite(motor2neg, LOW);
